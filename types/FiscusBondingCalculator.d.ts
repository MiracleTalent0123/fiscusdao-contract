...
interface FiscusBondingCalculatorInterface extends ethers.utils.Interface {
  functions: {
...
export class FiscusBondingCalculator extends BaseContract {
  ...
  interface: FiscusBondingCalculatorInterface;
