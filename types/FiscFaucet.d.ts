...
interface FiscFaucetInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setFisc(address)": FunctionFragment;
  };
  ...
  encodeFunctionData(functionFragment: "setFisc", values: [string]): string;
  ...
  decodeFunctionResult(functionFragment: "setFisc", data: BytesLike): Result;
...
export class FiscFaucet extends BaseContract {
  ...
  callStatic: {
    ...
    setFisc(_fisc: string, overrides?: CallOverrides): Promise<void>;
  };
