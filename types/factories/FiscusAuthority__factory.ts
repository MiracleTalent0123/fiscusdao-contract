...
import type {
  FiscusAuthority,
  FiscusAuthorityInterface,
} from "../FiscusAuthority";
...
export class FiscusAuthority__factory extends ContractFactory {
  constructor(
  ...
  attach(address: string): FiscusAuthority {
    return super.attach(address) as FiscusAuthority;
  }
  connect(signer: Signer): FiscusAuthority__factory {
    return super.connect(signer) as FiscusAuthority__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): FiscusAuthorityInterface {
    return new utils.Interface(_abi) as FiscusAuthorityInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): FiscusAuthority {
    return new Contract(address, _abi, signerOrProvider) as FiscusAuthority;
  }
}
