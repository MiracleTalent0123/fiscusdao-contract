...
interface FiscusBondDepositoryInterface extends ethers.utils.Interface {
  functions: {
...
export class FiscusBondDepository extends BaseContract {
  ...
  interface: FiscusBondDepositoryInterface;
