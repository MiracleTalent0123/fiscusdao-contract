...
interface IFiscusAuthorityInterface extends ethers.utils.Interface {
  functions: {
...
export class IFiscusAuthority extends BaseContract {
  ...
  interface: IFiscusAuthorityInterface;
