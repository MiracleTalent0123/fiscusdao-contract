...
interface GovernorFISCegaDelegateInterface extends ethers.utils.Interface {
  functions: {
    ...
    "getVotesFromPercentOfsFISCSupply(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getVotesFromPercentOfsFISCSupply",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export class GovernorFISCegaDelegate extends BaseContract {
  ...
  interface: GovernorFISCegaDelegateInterface;
  ...
  functions: {
    ...
    getVotesFromPercentOfsFISCSupply(
