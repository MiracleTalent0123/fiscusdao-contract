...
interface GovernorFISCegaDelegatorInterface extends ethers.utils.Interface {
  functions: {
...
export class GovernorFISCegaDelegator extends BaseContract {
  ...
  interface: GovernorFISCegaDelegatorInterface;
