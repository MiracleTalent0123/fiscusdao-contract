...
interface GovernorFISCegaEventsInterface extends ethers.utils.Interface {
  functions: {};
...
export class GovernorFISCegaEvents extends BaseContract {
  ...
  interface: GovernorFISCegaEventsInterface;
