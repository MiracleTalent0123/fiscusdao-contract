export const CONTRACTS: Record<string, string> = {
  fisc: "FiscusERC20Token",
  sFisc: "sFiscus",
  gFisc: "gFISC",
  staking: "FiscusStaking",
  distributor: "Distributor",
  treasury: "FiscusTreasury",
  bondDepo: "FiscusBondDepository",
  teller: "BondTeller",
  bondingCalculator: "FiscusBondingCalculator",
  authority: "FiscusAuthority",
  migrator: "FiscusTokenMigrator",
  FRAX: "Frax",
  DAI: "DAI",
};
