...
contract FiscusBondDepository is FiscusAccessControlled {
  ...
  function deposit(
    ...
    require(payout >= 10000000, "Bond too small"); // must be > 0.01 FISC ( underflow protection )
  ...
  /**
   * @notice calculate current ratio of debt to FISC supply
   * @param _BID uint
