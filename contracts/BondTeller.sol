...
contract BondTeller is ITeller, FiscusAccessControlled {
    /* ========== DEPENDENCIES ========== */
    ...
    struct Bond {
        ...
        uint256 payout; // sFISC remaining to be paid. agnostic balance
    ...
    IERC20 internal immutable FISC;
    IsFISC internal immutable sFISC; // payment token
    ...
    function newBond(
        ...
        FISC.approve(address(staking), _payout);
    ...
    function getReward() external override {
        ...
        FERs[msg.sender] = 0;
        FISC.safeTransfer(msg.sender, reward);
    }
    ...
    function pay(address _bonder, uint256 _amount) internal {
        sFISC.safeTransfer(_bonder, _amount);
    }
    ...
    /**
     * @notice calculate amount of FISC available for claim for single bond
     * @param _bonder address
    ...
    /**
     * @notice calculate amount of FISC available for claim for array of bonds
     * @param _bonder address
