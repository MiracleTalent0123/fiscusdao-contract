...
contract gFISC is IgFISC, ERC20 {
    ...
    constructor(address _migrator, address _sFISC)
        ERC20("Governance FISC", "gFISC", 18)
    {
     ...
     * @param _sFISC address
     */
    function migrate(address _staking, address _sFISC) external override onlyApproved {
        ...
        require(_sFISC != address(0), "Zero address found");
        sFISC = IsFISC(_sFISC);
    }
    ...
    /**
     * @notice pull index from sFISC token
     */
    ...
    /**
        @notice converts gFISC amount to FISC
        @param _amount uint
        @return uint
     */
    ...
    /**
        @notice converts FISC amount to gFISC
        @param _amount uint
        @return uint
     */
    ...
    function getPriorVotes(address account, uint256 blockNumber) external view returns (uint256) {
        require(blockNumber < block.number, "gFISC::getPriorVotes: not yet determined");
